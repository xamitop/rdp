...
def main():
    parser = argparse.ArgumentParser(description='Proxy Checker Bot')
    parser.add_argument('-t', '--token', type=str, help='Telegram bot token', required=True)
    parser.add_argument('-g', '--group', type=str, help='Private group invite link', required=True)
    args = parser.parse_args()

    global TOKEN, GROUP_LINK
    TOKEN = args.token
